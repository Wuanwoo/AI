...
class TableNetModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('train_f1_score', self.f1_score(output_table, labels_table))
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('validation_f1_score', self.f1_score(output_table, labels_table))
        return loss_table + loss_column
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log('test_f1_score', self.f1_score(output_table, labels_table))
        return loss_table + loss_column
    ...
    def compute_f1_score(self, preds, targets):
        preds = preds > 0.5
        targets = targets > 0.5
